...
# brute force attacks, 329–331
# BSEN 15713, 166
# BSIMM (building security in maturity model), 764
# bug fixing, 769–770
...
# change management, 147–148, 672–673,770–773
# CHAP (Challenge Handshake Authentication Protocol), 461, 465
...
# integrity, 4, 485
# limitations, 4–6
# CIP (critical infrastructure protection) plan, 77, 106–107
...
# CLOUD Act (Clarifying Lawful Overseas Use of Data), 171
...
# CloudFlare, 448
# CMMI (Capability Maturity Model Integration), 755, 758, 762–764
# CMS (credential management system),
# COBIT (Control Objectives for Information and
# Related Technologies), 105, 182, 195, 545
# code repositories access control, 801
# code segregation, 801–802
# source code, 798–800
# code review and testing, 567–571
# coding
# CVE (Common Vulnerabilities and Exposures), 859
# CWE, 854–855
# CWRAF, 855–856
# CWSS, 856
...
# COPE (corporate-owned personally enabled), 444
# copyrights, 33
# CORBA (Common Object Request Broker Architecture), 738
...
# DevSecOps, IPT (integrated product team), 776
# DFA (differential fault analysis) attacks,

# DFDs (data flow diagrams), 112
# DHCP (Dynamic Host Configuration Protocol), 376–377
# differential backup, 199
...
# economy of mechanism, 217
# ECPA (Electronic Communications Privacy Act), 40–41, 171
...
# endpoints, 429
# end-to-end encryption, 206
# ENIAC (Electronic Numerical Integrator and Computer), 723
# Enigma, 264
# ENISA (European Union Agency for Network and Information Security), 477
# environments
# DBMSs, 785
# ACID, 786–787
# database models, 789–791
...
# financial information, background checks and, 85
# Financial Services Modernization Act, 40
# FIPS (Federal Information Processing Standards), 192
# firewalls
# bastion host/screened host, 415–416
...
# FMEA (Failure Modes and Effect Analysis), 823
...
# GCHQ (Government Communications Headquarters), 25
# GDPR (General Data Protection Regulation),41–45, 169
# genesis block, 520
# gift policies, 90–91
...
# GRC (governance, risk management, and compliance), 62, 580
# GSM (Global System for Mobile Communications), 441
...
# screening, 83–88
# skills, 82
# HITRUST CSF (Health Information Trust  Alliance Common Security Framework Common Security Framework), 106, 238
# HMAC (Hash-based Message Authentication Code), 324
# honeypots/honeynets, 667
# host addressing, 369
# HSM (hardware security module), 241, 251–252, 265, 316, 525
...
# IAM (Identity and Access Management), 483–484
# accountability
# cloud, 527
# CMS, 524–525
...
# ICT (Information and Communication Technology), 183
# identity proofing, 493
# IDPS (intrusion detection and prevention system), 621
# IDS/IPS (intrusion detection and prevention),
# best practices, 622–623
# IDSs (intrusion detection systems), 412, 421–422, 621
...
# IGMP (Internet Group Management Protocol), 372
...
# iPhone, 752
# IPPD (Integrated Product and Process Development), 773–774
...
# ISA-99, 107–108
# ISACA (Information Systems Audit and Control Association), 238, 545
# ISAE 3402, 544
# ISA/IEC 62443, 107–108
# (ISC)2 Code of Ethics, 56–57
# ISCM (information security continuous monitoring), 575–577
# ISCP (information system contingency plan), 78
# iSCSI (Internet Small Computer System Interface), 395
# ISDN (integrated services digital network), 468
# ISM (Information Security Manual), 183
# ISMS (Information Security Management System), 486
...
# CMDB (configuration management database), 148
# ITLOS (International Tribunal for Law of the Sea), 13
...
# LEAP (Lightweight Extensible Authentication Protocol), 398
# least common mechanism, 220
...
# machine state, TPM (Trusted Platform Module), 248
...
# MAOT (maximum acceptable outage time), 63
# marking data, 208–209, 647
# MARS-E (Minimum Acceptable Risk Standards for Exchanges), 810
# maturity models
# BSIMM (building security in maturity model), 764
# building, 756–760
...
# domains, 755
# levels, 755
# SAMM (Software Assurance Maturity Model), 764–767
# selection, 756
# targets, 756
# MBCO (minimum business continuity objective), 63
...
# NAFTA (North American Free Trade Agreement), 13
# Napolenoic Code, 10
# NAT (network address translation), 412,
# NATO Article 5, 27
# NBDRA (NIST Big Data Reference Architecture), 174
...
# Reliability Corporation Critical Infrastructure Protection), 106
# .NET, 733–734
# Netflow, 273
...
# routers, 426
# security, 412
# SIEM (security information and event management), 422–423
# switches, 425–426
...
# O 
# OASIS (Organization for Advancement of Structured Information Standards), 495
# OAuth 2.0, 523, 747
# obfuscation of data, 210
# objectivity, C3 (Cyber Security Credentials Collaborative), 55
# object-oriented programming, 725
# OCSP (Online Certificate Status Protocol), 517
# OCTAVE (Operationally Critical Threat, Asset, and Vulnerability Evaluation), 115–116, 822
...
# OPEC (Organization of Petroleum Exporting Countries), 13
# open design, 218–219
...
# OWASP (Open Web Application Security Project), 60, 279, 748
# cheat sheet, 811
...
# salting, 498
# weak, 281
# PASTA (Process for Attack Simulation and Threat Analysis), 114–115
...
# PCI DSS (Payment Card Industry Data Security Standard), 108–109, 176, 238, 544, 809
# PCI SSC (Payment Card Industry Security Standards Council), 108, 544
...
# preponderance of evidence in investigations, 611
# presentation layer, OSI layer 6, 366,
# privacy collection limitation, 172
# cross-border
# APEC, 155–156
# CBPR, 155–156
# EU, 153–154
...
# APEC (Asia-Pacific Economic Cooperation), 39
...
# RADIUS (Remote Authentication Dial-In User Service), 461, 522
...
# Schroeder, M.D., 216
# SCIF (sensitive compartmented information facilities), 692
...
# for Applications in Multivendor Environment), 495
# session hijacking, 283
...
# single sign-on
# SAML (Security Assertion Markup Language), 495
# SESAME (Secure European System
# for Applications in Multivendor Environment), 495
# site design, 342–343
...
# S/MIME (Secure Multipurpose Internet Mail Extensions), 457
# snapshots, 200
# SNMP (Simple Network Management  Protocol), TCP/IP, 382
# Snowden, Edward, 24
...
# selection, 756
# targets, 756
# Microsoft SDL (Security Development Lifecycle), 720–721
# mobile apps
# Android, 752
# device security, 753
# iOS mobile operating system, 752
...
# SPAP (Shiva Password Authentication Protocol), 465
# Spectre, 243–244
# SPIT (Spam over Internet Telephony) attacks,
# split knowledge, 317
# SPML (Service Provisioning Markup Language), 496
# SQL injection, vulnerabilities, 279–280
# SSAE 18 (Standards for Attestation Engagements), 543–544
...
# STIX (Structured Threat Information Expression), 31, 423
...
# supply chain risks, 116–119
# SWGDE (Scientific Working Group on Digital Evidence), 617
...
# TACACS+ (Terminal Access Controller Access Control System Plus), 461
# TAXII (Trusted Automated Exchange of Indicator Information), 31, 423
# TCP (Transmission Control Protocol), 373, 384
# TCP/IP (Transmission Control Protocol/ Internet Protocol), 384
...
# WiFi, vulnerabilities, 290
# WikiLeaks, 21–22
# WIPO (World International Property Organization), 36
# wireless access points, 427
